//const MessengerType = process.env.messengerType;

const Config = require('./configs/config.json');
const Messages = require('./configs/messages/' + Config.General.languageCode + '.json');
...
const Database_Module = require('./modules/messengers/telegram/Database');
const Database = new Database_Module();

const SteamAPI_Module = require('./modules/messengers/telegram/SteamAPI');
const SteamAPI = new SteamAPI_Module(Config, Database);

const Telegram_Module = require('./modules/messengers/telegram/Telegram');
const Telegram = new Telegram_Module(Config, Messages);

Telegram.telegramBot.getMe().then(() => {
    recursiveLoop();
    Utility.log('INFO', 'Telegram', 'getMe', 'Steam Ban Checker Initialized');
